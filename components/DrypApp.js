...
const Btn=({children,primary,danger,small,disabled,style,...p})=><button {...p} style={{display:"inline-flex",alignItems:"center",gap:6,padding:small?"5px 12px":"8px 16px",minHeight:small?32:undefined,borderRadius:8,fontSize:small?12:13,fontWeight:600,background:danger?T.red:primary?T.acc:T.accD,color:danger?"#fff":primary?T.bg:T.txt,border:primary||danger?"none":`1px solid ${T.acc}44`,opacity:disabled?.4:1,cursor:disabled?"not-allowed":"pointer",transition:"all .15s",...style}} disabled={disabled}/>
